...
public class PDFView extends RelativeLayout {
    ...
    private void load(DocumentSource docSource, String password, int[] userPages) {
       ...
       /* if (DOWNLOAD_THREAD_POOL_EXECUTOR.getQueue().size() > 0) {
            clearThreads();
            DocumentSource docSource1 = docSource;
            final String fPassword = password;
            decodingAsyncTask = new DecodingAsyncTask(docSource1, fPassword, userPages, this, pdfiumCore);
    ...
    public String getTextPage(int pageIndex){
